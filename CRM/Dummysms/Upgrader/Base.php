 ...
 */
class CRM_Dummysms_Upgrader_Base {

  /**
   * @var CRM_Dummysms_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Dummysms_Upgrader(
        'dummysms',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Dummysms_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Dummysms_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
